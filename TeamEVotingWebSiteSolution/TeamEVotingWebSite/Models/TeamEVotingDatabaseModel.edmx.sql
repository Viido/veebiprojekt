...
-- --------------------------------------------------
-- Date Created: 10/28/2018 20:12:13
...
GO
IF OBJECT_ID(N'[dbo].[FK_FactionRegionSet_FactionSet]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FactionRegionSet] DROP CONSTRAINT [FK_FactionRegionSet_FactionSet];
GO
IF OBJECT_ID(N'[dbo].[FK_FactionRegionSet_RegionSet]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FactionRegionSet] DROP CONSTRAINT [FK_FactionRegionSet_RegionSet];
GO
IF OBJECT_ID(N'[dbo].[FK_UserSetVisitorInfo]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[VisitorInfo] DROP CONSTRAINT [FK_UserSetVisitorInfo];
GO
...
CREATE TABLE [dbo].[FactionSet] (
    ...
    [Faction_ImageLogo] varchar(250)  NULL,
    [Faction_ImageLogoTitle] varchar(max)  NULL
);
GO
